...
class MainActivity : AppCompatActivity() {
    ...
    private val url = "https://eager-meitner-f8adb8.netlify.app/.netlify/functions/random"
    ...
    private fun loadMeme(){
        ...
        mJsonRequest = JsonObjectRequest(Request.Method.GET, url, null,
            { response ->
                 currentMemeUrl = response.getString("url")
                val imageView = findViewById<View>(R.id.imageMeme) as ImageView
